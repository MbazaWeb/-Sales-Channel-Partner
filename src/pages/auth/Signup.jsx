	...
	return (
		<div className="mx-auto flex min-h-screen max-w-3xl items-center justify-center px-4 py-10 lg:px-8">
			<Card className="w-full max-w-2xl p-8 lg:p-10">
				...
				<h2 className="mt-4 text-3xl font-semibold text-slate-900">Register for onboarding</h2>
				<p className="mt-3 text-sm text-slate-600">
					Public registration is for standard applicant accounts only. The admin account is provisioned separately and must sign in with the granted credentials.
				</p>
